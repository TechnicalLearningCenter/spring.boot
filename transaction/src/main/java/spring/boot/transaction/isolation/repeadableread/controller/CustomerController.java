package spring.boot.transaction.isolation.repeadableread.controller;

import spring.boot.transaction.isolation.repeadableread.domain.Customer;
import spring.boot.transaction.isolation.repeadableread.service.UserService;
...
public class CustomerController {
    ...
    public void updateCustomer(Customer customer) {
        ...
        sleep(threadName);
        System.err.println(threadName + "- Customer salary rolled back");
