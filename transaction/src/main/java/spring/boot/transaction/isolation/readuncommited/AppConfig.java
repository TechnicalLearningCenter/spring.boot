package spring.boot.transaction.isolation.readuncommited;
 ...
 */
@Configuration
@ComponentScan("spring.boot.transaction.isolation.readuncommited")
...
//        <property name="defaultAutoCommit" value="false" />
    ...
    public LocalSessionFactoryBean getLocalSessionFactory() {
        ...
        localSessionFactoryBean.setPackagesToScan("spring.boot.transaction.isolation.readuncommited.domain");
