 ...
 */
@Configuration
@ComponentScan("spring.boot.transaction.isolation.readcommited")
...
//        <property name="defaultAutoCommit" value="false" />
    ...
    public LocalSessionFactoryBean getLocalSessionFactory() {
        ...
        localSessionFactoryBean.setPackagesToScan("spring.boot.transaction.isolation.readcommited.domain");
