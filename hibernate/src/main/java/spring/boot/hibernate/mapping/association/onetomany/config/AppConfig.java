package spring.boot.hibernate.mapping.association.onetomany.config;
 ...
 */
@Configuration
@ComponentScan("spring.boot.hibernate.mapping.association.onetomany")
...
public class AppConfig {
    ...
    public LocalSessionFactoryBean getLocalSessionFactory() {
        ...
        localSessionFactoryBean.setPackagesToScan("spring.boot.hibernate.mapping.association.onetomany.domain");
