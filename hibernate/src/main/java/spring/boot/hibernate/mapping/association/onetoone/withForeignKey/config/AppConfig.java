package spring.boot.hibernate.mapping.association.onetoone.withForeignKey.config;
 ...
 */
@Configuration
@ComponentScan("spring.boot.hibernate.mapping.association.onetoone.withForeignKey")
...
public class AppConfig {
    ...
    public LocalSessionFactoryBean getLocalSessionFactory() {
        ...
        localSessionFactoryBean.setPackagesToScan("spring.boot.hibernate.mapping.association.onetoone.withForeignKey.domain");
